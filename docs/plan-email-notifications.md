...
- [ ] Milestone 4: Wire everything together in handlers and Program.fs
- [ ] Milestone 5: Tests
- [ ] Milestone 6: Update EARS spec and deferred items
...
Update `docs/ears-booking.md` to add requirements for email notifications and remove the "Email notifications" entry from the "Deferred from specification" section.
