...
var $author$project$Api$checkSession = function (toMsg) {
...
var $author$project$Main$BookingDetailPage = function (a) {
	return {$: 'BookingDetailPage', a: a};
};
var $author$project$Main$BookingsMsg = function (a) {
	return {$: 'BookingsMsg', a: a};
};
...
var $author$project$Types$Booking = function (id) {
	return function (participantName) {
		return function (participantEmail) {
			return function (participantPhone) {
									...
									return function (timezone) {
										return function (status) {
											return function (createdAt) {
												return {createdAt: createdAt, description: description, durationMinutes: durationMinutes, endTime: endTime, id: id, participantEmail: participantEmail, participantName: participantName, participantPhone: participantPhone, startTime: startTime, status: status, timezone: timezone, title: title};
											};
										};
									};
								};
...
var $author$project$Api$bookingStatusDecoder = A2(
	...
	function (str) {
		switch (str) {
			case 'confirmed':
				return $elm$json$Json$Decode$succeed($author$project$Types$Confirmed);
			case 'cancelled':
				return $elm$json$Json$Decode$succeed($author$project$Types$Cancelled);
			default:
				var other = str;
				return $elm$json$Json$Decode$fail('Unknown booking status: ' + other);
		}
	},
	$elm$json$Json$Decode$string);
...
var $author$project$Api$bookingDecoder = A3(
	...
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'status',
		$author$project$Api$bookingStatusDecoder,
		A3(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'timezone',
			$elm$json$Json$Decode$string,
	...
	A3(
		...
		A3(
			...
			A3(
				...
				$elm$json$Json$Decode$succeed($author$project$Types$PaginatedBookings)))));
...
var $author$project$Types$DashboardStats = F3(
	function (upcomingCount, nextBookingTime, nextBookingTitle) {
		return {nextBookingTime: nextBookingTime, nextBookingTitle: nextBookingTitle, upcomingCount: upcomingCount};
	});
var $author$project$Api$dashboardStatsDecoder = A4(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
	'nextBookingTitle',
	$elm$json$Json$Decode$nullable($elm$json$Json$Decode$string),
	$elm$core$Maybe$Nothing,
	A4(
		...
		A3(
			...
			'upcomingCount',
			$elm$json$Json$Decode$int,
			$elm$json$Json$Decode$succeed($author$project$Types$DashboardStats))));
var $author$project$Api$fetchDashboardStats = function (toMsg) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, toMsg, $author$project$Api$dashboardStatsDecoder),
			url: '/api/admin/dashboard'
		});
};
var $author$project$Page$Dashboard$init = _Utils_Tuple2(
	{error: $elm$core$Maybe$Nothing, loading: true, stats: $elm$core$Maybe$Nothing},
	$author$project$Api$fetchDashboardStats($author$project$Page$Dashboard$StatsReceived));
...
var $author$project$Main$loadPage = F2(
	function (route, model) {
		switch (route.$) {
			case 'Dashboard':
				var _v1 = $author$project$Page$Dashboard$init;
				var subModel = _v1.a;
				var subCmd = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'Bookings':
				var _v2 = $author$project$Page$Bookings$init;
				var subModel = _v2.a;
				var subCmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: $author$project$Main$BookingsPage(subModel)
						}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$BookingsMsg, subCmd));
			case 'BookingDetail':
				var id = route.a;
				var _v3 = $author$project$Page$BookingDetail$init(id);
				var subModel = _v3.a;
				var subCmd = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: $author$project$Main$BookingDetailPage(subModel)
						}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$BookingDetailMsg, subCmd));
			case 'Login':
				var _v4 = $author$project$Page$Login$init;
				var subModel = _v4.a;
				var subCmd = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: $author$project$Main$LoginPage(subModel)
						}),
...
var $author$project$Api$logout = function (toMsg) {
...
var $author$project$Api$cancelBooking = F2(
	function (id, toMsg) {
		return $elm$http$Http$post(
			{
				body: $elm$http$Http$emptyBody,
		...
		switch (msg.$) {
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								booking: $elm$core$Maybe$Just(booking),
								loading: false
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Just('Failed to load booking.'),
								loading: false
							}),
						$elm$core$Platform$Cmd$none);
				}
			...
			case 'CancelConfirmed':
				return _Utils_Tuple2(
					...
					A2($author$project$Api$cancelBooking, model.bookingId, $author$project$Page$BookingDetail$CancellationCompleted));
			default:
				if (msg.a.$ === 'Ok') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{cancelling: false}),
						A2($author$project$Api$fetchBooking, model.bookingId, $author$project$Page$BookingDetail$BookingReceived));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								cancelling: false,
								error: $elm$core$Maybe$Just('Failed to cancel booking.')
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
	});
var $author$project$Page$Bookings$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'BookingsReceived':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{bookings: result.bookings, loading: false, page: result.page, pageSize: result.pageSize, totalCount: result.totalCount}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Just('Failed to load bookings.'),
								loading: false
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'PageChanged':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{loading: true, page: newPage}),
					A4($author$project$Api$fetchBookings, newPage, model.pageSize, model.statusFilter, $author$project$Page$Bookings$BookingsReceived));
			default:
				var filter = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{loading: true, page: 1, statusFilter: filter}),
		...
		if (msg.a.$ === 'Ok') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						error: $elm$core$Maybe$Just('Failed to load dashboard stats.'),
						loading: false
					}),
				$elm$core$Platform$Cmd$none);
		}
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'LogoutClicked':
				return _Utils_Tuple2(
					model,
					$author$project$Api$logout($author$project$Main$LogoutCompleted));
			...
			case 'DashboardMsg':
				...
				if (_v4.$ === 'DashboardPage') {
					var subModel = _v4.a;
					var _v5 = A2($author$project$Page$Dashboard$update, subMsg, subModel);
			...
			case 'BookingsMsg':
				...
				if (_v6.$ === 'BookingsPage') {
					var subModel = _v6.a;
					var _v7 = A2($author$project$Page$Bookings$update, subMsg, subModel);
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: $author$project$Main$BookingsPage(newSubModel)
							}),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$BookingsMsg, subCmd));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'BookingDetailMsg':
				var subMsg = msg.a;
				var _v8 = model.page;
				if (_v8.$ === 'BookingDetailPage') {
					var subModel = _v8.a;
					var _v9 = A2($author$project$Page$BookingDetail$update, subMsg, subModel);
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: $author$project$Main$BookingDetailPage(newSubModel)
							}),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$BookingDetailMsg, subCmd));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $author$project$View$Components$card = function (children) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('bg-white rounded-lg shadow-sm border border-sand-200 p-6')
			]),
		children);
};
	...
	return $author$project$View$Components$card(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('text-sm text-sand-700 mb-4')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Are you sure you want to cancel this booking? This cannot be undone.')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
...
var $author$project$Page$BookingDetail$detailField = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('text-xs font-medium text-sand-500 uppercase tracking-wider mb-1')
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('text-sm text-sand-900')
						]),
					_List_fromArray(
						[
...
var $author$project$View$Components$statusBadge = function (status) {
	var _v0 = function () {
		if (status.$ === 'Confirmed') {
			return _Utils_Tuple2('Confirmed', 'bg-green-100 text-green-800');
		} else {
			return _Utils_Tuple2('Cancelled', 'bg-red-100 text-red-800');
		}
	}();
	var label = _v0.a;
	var classes = _v0.b;
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('inline-block px-2 py-1 rounded-full text-xs font-medium ' + classes)
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(label)
...
var $author$project$Page$BookingDetail$bookingDetailView = F2(
	function (model, booking) {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$View$Components$pageHeading(booking.title),
							$author$project$View$Components$statusBadge(booking.status)
						])),
					$author$project$View$Components$card(
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Page$BookingDetail$detailField, 'Participant', booking.participantName),
									A2($author$project$Page$BookingDetail$detailField, 'Email', booking.participantEmail),
									function () {
									var _v0 = booking.participantPhone;
									if (_v0.$ === 'Just') {
										var phone = _v0.a;
										return A2($author$project$Page$BookingDetail$detailField, 'Phone', phone);
									} else {
										return $elm$html$Html$text('');
									}
								}(),
									...
									$author$project$Page$BookingDetail$detailField,
									'Duration',
									$elm$core$String$fromInt(booking.durationMinutes) + ' minutes'),
									A2($author$project$Page$BookingDetail$detailField, 'Timezone', booking.timezone),
									function () {
									var _v1 = booking.description;
									if (_v1.$ === 'Just') {
										var desc = _v1.a;
										return A2($author$project$Page$BookingDetail$detailField, 'Description', desc);
									} else {
										return $elm$html$Html$text('');
									}
								}(),
					...
					if (_v2.$ === 'Confirmed') {
						return A2(
							...
							_List_fromArray(
								[
									model.cancelConfirm ? $author$project$Page$BookingDetail$confirmCancelView(model) : $author$project$View$Components$dangerButton(
									{isDisabled: false, isLoading: model.cancelling, label: 'Cancel Booking', onPress: $author$project$Page$BookingDetail$CancelClicked})
								]));
					} else {
						return $elm$html$Html$text('');
					}
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('flex items-center gap-2 mb-6')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('text-sm text-sand-400')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('/')
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('text-sm text-sand-700')
							]),
						_List_fromArray(
							[
				...
				function () {
				if (model.loading) {
					return $author$project$View$Components$loadingSpinner;
				} else {
					var _v1 = model.booking;
					if (_v1.$ === 'Just') {
						var booking = _v1.a;
						return A2($author$project$Page$BookingDetail$bookingDetailView, model, booking);
					} else {
						return $elm$html$Html$text('');
					}
				}
...
var $author$project$Page$Bookings$bookingRow = function (booking) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('border-b border-sand-100 hover:bg-sand-50 transition-colors')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(booking.title)
							]))
					])),
				A2(
				$elm$html$Html$td,
				...
				_List_fromArray(
					[
						$elm$html$Html$text(booking.participantName)
					])),
				A2(
				$elm$html$Html$td,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(booking.durationMinutes) + ' min')
					])),
				A2(
				$elm$html$Html$td,
				_List_fromArray(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Participant')
											])),
										A2(
										$elm$html$Html$th,
										_List_fromArray(
...
var $author$project$Page$Bookings$emptyState = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$Page$Bookings$filterButton = F3(
	function (label, filterValue, currentFilter) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('px-4 py-2 rounded-lg text-sm font-medium transition-colors ' + classes),
					$elm$html$Html$Events$onClick(
					$author$project$Page$Bookings$StatusFilterChanged(filterValue))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(label)
...
var $author$project$Page$Bookings$filterBar = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Page$Bookings$pagination = function (model) {
	...
	var hasNext = _Utils_cmp(model.page, totalPages) < 0;
	return (totalPages <= 1) ? $elm$html$Html$text('') : A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Showing page ' + ($elm$core$String$fromInt(model.page) + (' of ' + $elm$core$String$fromInt(totalPages))))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						hasPrev ? $author$project$View$Components$secondaryButton(
						{
							label: 'Previous',
							onPress: $author$project$Page$Bookings$PageChanged(model.page - 1)
						}) : $elm$html$Html$text(''),
						hasNext ? $author$project$View$Components$secondaryButton(
						{
							label: 'Next',
							onPress: $author$project$Page$Bookings$PageChanged(model.page + 1)
						}) : $elm$html$Html$text('')
...
var $author$project$Page$Bookings$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$author$project$View$Components$pageHeading('Bookings'),
				function () {
				var _v0 = model.error;
				if (_v0.$ === 'Just') {
					var err = _v0.a;
				...
				$author$project$Page$Bookings$filterBar(model),
				model.loading ? $author$project$View$Components$loadingSpinner : ($elm$core$List$isEmpty(model.bookings) ? $author$project$Page$Bookings$emptyState : A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('text-sm font-medium text-sand-500 uppercase tracking-wider mb-2')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Upcoming Bookings')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('text-3xl font-display text-sand-900')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								$elm$core$String$fromInt(stats.upcomingCount))
							])),
						A2(
						$elm$html$Html$a,
						_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Next Booking')
							])),
						function () {
						var _v0 = stats.nextBookingTime;
						if (_v0.$ === 'Just') {
							var time = _v0.a;
							return A2(
								$elm$html$Html$div,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('text-lg text-sand-900')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text(
							...
							return A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('text-sand-400 text-lg')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('No upcoming bookings')
									]));
						}
					}()
					]))
...
var $author$project$Page$Dashboard$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$View$Components$pageHeading('Dashboard'),
				function () {
				var _v0 = model.error;
				if (_v0.$ === 'Just') {
					var err = _v0.a;
				...
				if (model.loading) {
					...
					if (_v1.$ === 'Just') {
						var stats = _v1.a;
						return $author$project$Page$Dashboard$statsView(stats);
					} else {
						return $elm$html$Html$text('');
					}
				}
...
var $author$project$Page$Login$LoginFormSubmitted = {$: 'LoginFormSubmitted'};
var $author$project$Page$Login$PasswordUpdated = function (a) {
...
var $author$project$Page$Login$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('min-h-screen flex items-center justify-center bg-sand-50')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('w-full max-w-sm')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('font-display text-2xl text-sand-900 mb-2 text-center')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Michael Admin')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('text-sand-500 text-sm text-center mb-8')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Sign in to manage your calendar.')
							])),
						function () {
						var _v0 = model.error;
						if (_v0.$ === 'Just') {
							...
							return A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('mb-4 px-4 py-3 bg-red-50 border border-red-200 rounded-lg text-red-700 text-sm')
									]),
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onSubmit($author$project$Page$Login$LoginFormSubmitted)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$class('w-full border border-sand-300 rounded-lg px-4 py-3 text-sand-900 text-sm focus:outline-none focus:border-coral transition-colors mb-4'),
										$elm$html$Html$Attributes$placeholder('Password'),
										$elm$html$Html$Attributes$value(model.password),
										$elm$html$Html$Events$onInput($author$project$Page$Login$PasswordUpdated)
									]),
								_List_Nil),
								A2(
								$elm$html$Html$button,
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$class('w-full bg-coral text-white px-5 py-3 rounded-lg text-sm font-medium hover:bg-coral-dark transition-colors disabled:opacity-40'),
										$elm$html$Html$Attributes$disabled(model.loading)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										model.loading ? 'Signing in...' : 'Sign in')
									]))
							]))
					]))
			]));
...
var $author$project$Main$pageView = function (model) {
	...
	switch (_v0.$) {
		...
		case 'BookingsPage':
			...
			return A2(
				$elm$html$Html$map,
				$author$project$Main$BookingsMsg,
				$author$project$Page$Bookings$view(subModel));
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('text-sand-400')
							]),
						_List_fromArray(
							[
	...
	function (currentRoute, targetRoute, label) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$href(
					$author$project$Route$toPath(targetRoute)),
					$elm$html$Html$Attributes$class('block px-4 py-2 rounded-lg text-sm font-medium transition-colors ' + activeClasses)
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(label)
...
var $author$project$View$Layout$sidebar = function (config) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class(
				'fixed inset-y-0 left-0 z-30 w-64 bg-sand-800 text-sand-200 transform transition-transform duration-200 md:relative md:translate-x-0 ' + (config.navOpen ? 'translate-x-0' : '-translate-x-full'))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('font-display text-xl text-white mb-8')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Michael')
							])),
						A2(
						$elm$html$Html$nav,
						_List_fromArray(
...
var $author$project$View$Layout$topBar = function (config) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('bg-white border-b border-sand-200 px-6 py-4 flex items-center justify-between md:justify-end')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('md:hidden text-sand-600 hover:text-sand-900'),
...
var $author$project$View$Layout$view = function (config) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('min-h-screen flex')
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('flex-1 flex flex-col min-h-screen')
					]),
				_List_fromArray(
					[
						$author$project$View$Layout$topBar(config),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('flex-1 bg-sand-50 p-6 md:p-8')
							]),
						_List_fromArray(
							[config.content]))
					]))
